...
const schemaSql = [
  ...
  `CREATE TABLE IF NOT EXISTS department_racks (id text PRIMARY KEY, warehouse_code text NOT NULL, name text NOT NULL, code text NOT NULL, rows integer NOT NULL, columns integer NOT NULL, storage_type text NOT NULL DEFAULT 'rack', width double precision NOT NULL DEFAULT 4, depth double precision NOT NULL DEFAULT 1.2, pos_x double precision NOT NULL DEFAULT 0, pos_z double precision NOT NULL DEFAULT 0, rotation double precision NOT NULL DEFAULT 0, archived boolean NOT NULL DEFAULT false, created_at text NOT NULL DEFAULT CURRENT_TIMESTAMP)`,
  `ALTER TABLE department_racks ADD COLUMN IF NOT EXISTS storage_type text NOT NULL DEFAULT 'rack'`,
  `ALTER TABLE department_racks ADD COLUMN IF NOT EXISTS width double precision NOT NULL DEFAULT 4`,
  `ALTER TABLE department_racks ADD COLUMN IF NOT EXISTS depth double precision NOT NULL DEFAULT 1.2`,
  `ALTER TABLE department_racks ADD COLUMN IF NOT EXISTS pos_x double precision NOT NULL DEFAULT 0`,
  `ALTER TABLE department_racks ADD COLUMN IF NOT EXISTS pos_z double precision NOT NULL DEFAULT 0`,
  `ALTER TABLE department_racks ADD COLUMN IF NOT EXISTS rotation double precision NOT NULL DEFAULT 0`,
  ...
  `CREATE TABLE IF NOT EXISTS department_products (id text PRIMARY KEY, warehouse_code text NOT NULL, name text NOT NULL, sku text NOT NULL, barcode text NOT NULL DEFAULT '', category text NOT NULL DEFAULT 'Материалы', subcategory text NOT NULL DEFAULT '', brand text NOT NULL DEFAULT '', color text NOT NULL DEFAULT '', ral text NOT NULL DEFAULT '', unit text NOT NULL DEFAULT 'шт.', pack_type text NOT NULL DEFAULT '', pack_size double precision NOT NULL DEFAULT 0, image_url text NOT NULL DEFAULT '', min_stock double precision NOT NULL DEFAULT 0, comment text NOT NULL DEFAULT '', one_c_id text, created_by text NOT NULL DEFAULT 'Кладовщик', source text NOT NULL DEFAULT 'manual', archived boolean NOT NULL DEFAULT false, created_at text NOT NULL DEFAULT CURRENT_TIMESTAMP)`,
  `ALTER TABLE department_products ADD COLUMN IF NOT EXISTS subcategory text NOT NULL DEFAULT ''`,
  `ALTER TABLE department_products ADD COLUMN IF NOT EXISTS brand text NOT NULL DEFAULT ''`,
  `ALTER TABLE department_products ADD COLUMN IF NOT EXISTS color text NOT NULL DEFAULT ''`,
  `ALTER TABLE department_products ADD COLUMN IF NOT EXISTS ral text NOT NULL DEFAULT ''`,
  `ALTER TABLE department_products ADD COLUMN IF NOT EXISTS pack_type text NOT NULL DEFAULT ''`,
  `ALTER TABLE department_products ADD COLUMN IF NOT EXISTS pack_size double precision NOT NULL DEFAULT 0`,
  `ALTER TABLE department_products ADD COLUMN IF NOT EXISTS image_url text NOT NULL DEFAULT ''`,
  `ALTER TABLE department_products ADD COLUMN IF NOT EXISTS comment text NOT NULL DEFAULT ''`,
  `ALTER TABLE department_products ADD COLUMN IF NOT EXISTS created_by text NOT NULL DEFAULT 'Кладовщик'`,
  `ALTER TABLE department_products ADD COLUMN IF NOT EXISTS source text NOT NULL DEFAULT 'manual'`,
  `ALTER TABLE department_products ADD COLUMN IF NOT EXISTS archived boolean NOT NULL DEFAULT false`,
  ...
  `CREATE TABLE IF NOT EXISTS department_movements (id text PRIMARY KEY, warehouse_code text NOT NULL, type text NOT NULL, product_id text NOT NULL REFERENCES department_products(id), from_cell_id text REFERENCES department_cells(id), to_cell_id text REFERENCES department_cells(id), quantity double precision NOT NULL, recipient text NOT NULL DEFAULT '', comment text NOT NULL DEFAULT '', operator text NOT NULL DEFAULT 'Кладовщик', document_number text NOT NULL DEFAULT '', source_name text NOT NULL DEFAULT '', source_location text NOT NULL DEFAULT '', batch_id text NOT NULL DEFAULT '', created_at text NOT NULL DEFAULT CURRENT_TIMESTAMP)`,
  `ALTER TABLE department_movements ADD COLUMN IF NOT EXISTS document_number text NOT NULL DEFAULT ''`,
  `ALTER TABLE department_movements ADD COLUMN IF NOT EXISTS source_name text NOT NULL DEFAULT ''`,
  `ALTER TABLE department_movements ADD COLUMN IF NOT EXISTS source_location text NOT NULL DEFAULT ''`,
  `ALTER TABLE department_movements ADD COLUMN IF NOT EXISTS batch_id text NOT NULL DEFAULT ''`,
  `CREATE INDEX IF NOT EXISTS idx_department_movements_warehouse_created ON department_movements(warehouse_code, created_at)`,

  `CREATE TABLE IF NOT EXISTS department_mixes (id text PRIMARY KEY, warehouse_code text NOT NULL, name text NOT NULL, recipient text NOT NULL DEFAULT '', document_number text NOT NULL DEFAULT '', result_quantity double precision NOT NULL DEFAULT 0, result_unit text NOT NULL DEFAULT 'кг', comment text NOT NULL DEFAULT '', operator text NOT NULL DEFAULT 'Кладовщик', created_at text NOT NULL DEFAULT CURRENT_TIMESTAMP)`,
  `CREATE INDEX IF NOT EXISTS idx_department_mixes_warehouse_created ON department_mixes(warehouse_code, created_at)`,
  `CREATE TABLE IF NOT EXISTS department_mix_lines (id text PRIMARY KEY, mix_id text NOT NULL REFERENCES department_mixes(id) ON DELETE CASCADE, product_id text NOT NULL REFERENCES department_products(id), cell_id text NOT NULL REFERENCES department_cells(id), quantity double precision NOT NULL, unit text NOT NULL DEFAULT 'кг')`,
  `CREATE INDEX IF NOT EXISTS idx_department_mix_lines_mix ON department_mix_lines(mix_id)`,

  `CREATE TABLE IF NOT EXISTS department_inventory_snapshots (id text PRIMARY KEY, warehouse_code text NOT NULL, snapshot_json text NOT NULL, created_by text NOT NULL DEFAULT 'Кладовщик', created_at text NOT NULL DEFAULT CURRENT_TIMESTAMP)`,
  `CREATE INDEX IF NOT EXISTS idx_department_inventory_warehouse_created ON department_inventory_snapshots(warehouse_code, created_at)`,
];
