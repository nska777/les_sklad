...
export default function RootLayout({
  ...
  return (
    <html lang="ru">
      <body className="antialiased"><PwaRegister /><MovementDateMaintenance /><OnecCellOccupancyGuard /><AddStockExceptionHelper /><RackTabRouter />{children}<MaterialsAddAction /><IssueMobileScanTools /><SessionMenu /><CodeZoom /><Toaster richColors position="top-right" /></body>
    </html>
  );
}
